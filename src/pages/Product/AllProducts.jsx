...
const AllProducts = ({ refresh, onChange }) => {
  ...
  // ----------------------------------------
  // Fetch Products — optimized with cancellation & debouncing
  // ----------------------------------------
  ...
  }, [currentPage, searchTerm, selectedCategory, refresh]);
        ...
        >
          ...
          <div className="flex gap-2 p-2">
            <button
              ...
              className="flex-1 py-2 rounded-xl text-xs font-semibold text-white bg-green-600 shadow hover:scale-105 transition"
            >
              ✏️ Edit
            </button>
            <button
              onClick={() => handleDelete(p._id)}
              className="flex-1 py-2 rounded-xl text-xs font-semibold text-white bg-red-500 shadow hover:scale-105 transition"
            >
              🗑 Delete
            </button>
          </div>
