...
const Order = () => {
  ...
  const handleRefresh = () => {
    ...
    setActiveTab("list"); // After report, show list
  };

  return (
    <div className="p-4 md:p-6 bg-[#F5F7F0] min-h-screen rounded-2xl">
      <h2 className="text-2xl md:text-3xl font-bold text-[#3F4F1D] mb-6 text-center md:text-left">
        📝 Orders Management
      </h2>
      ...
      <motion.div
        ...
        className="bg-white/70 backdrop-blur-xl border border-[#D2B48C]/50 rounded-2xl shadow-2xl p-4 md:p-6 overflow-x-auto"
      >
